...
public class ShopOnLine {
    ...
    public static Remera CrearRemera(Talles talle, double precio, String desc) {
        Remera remera = new Remera(talle, desc, precio);
        return remera;
    }

    public static Pantalon CrearPantalon(String modelo, double precio, String desc, Talles talle) {
        Pantalon pantalon = new Pantalon(talle, modelo, desc, precio);
        return pantalon;
    }

    public static Accesorio CrearAccesorio(Talles metal, String desc, double peso) {
        ...
        while (ingresar == 1) {
            ...
            switch (opc) {
                case 1:
                    ...
                    talle1 = talle1.valueOf(talle);
                    Remera remera = CrearRemera(talle1, precio, desc);
                ...
                case 2:
                    ...
                    talle1 = talle1.valueOf(talle);
                    System.out.println(talle1);
                    Pantalon p = CrearPantalon(modelo, precio, desc, talle1);
                ...
                case 3:
                    Talles metal1 = null;
                    String metal = JOptionPane.showInputDialog("Digite el material del accesorio que desea: 1 Oro, Plata, Acero en minuscula");
                    metal1 = metal1.valueOf(metal);

                    desc = JOptionPane.showInputDialog("Diigte la discripccion");

                    double peso = Double.parseDouble(JOptionPane.showInputDialog("Digite el peso del accesorio en KG"));
                    Accesorio accesorio = CrearAccesorio(metal1, desc, peso);
